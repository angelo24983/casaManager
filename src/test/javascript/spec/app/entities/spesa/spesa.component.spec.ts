...
import { SpesaComponent } from 'app/entities/spesa/spesa.component';
import { SpesaService } from 'app/entities/spesa/spesa.service';
import { Spesa } from 'app/shared/model/spesa.model';

describe('Component Tests', () => {
  describe('Spesa Management Component', () => {
    let comp: SpesaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpesaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.spesas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
